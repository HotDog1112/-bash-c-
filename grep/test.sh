...
# e n i v c l s
for flag in e n i v c l s o
do
  for pattern in $pattern_e $regular
    do
...
# 2 flag 1 file
for flag_1 in n i v c l s o
do
  for flag_2 in e n i v c l s o
  do
...
for flag_1 in n i v c l s o 
do
  for flag_2 in n i v c l s o
  do
    for flag_3 in e n i v c l s o
    do
      for pattern in $patterns $regular
        do
